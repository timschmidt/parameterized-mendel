		...
		difference () {
			union  (){
				...
				difference () {
					...
					translate ([0,x_car_lower_width/-2+9,x_car_bottom_height*1.2-2]) rotate ([-25,0,0])
				...
				translate ([0,(x_car_lower_width+x_car_shelf_width)/-2,x_car_bottom_height/2]) difference () {
					...
					translate ([0,0,x_car_bottom_height*0.8-1]) rotate ([25,0,0]) 		
						box(x_car_length+2,x_car_shelf_width*2,x_car_bottom_height);
				}
			}
			// Cylindrical gap for rod.
			translate ([0,x_car_lower_width/-2-3,x_car_bottom_height]) rotate ([0,90,0])
...
module cutouts() {
	union () {
		...
		// Trimming side with 2 axles on.
		translate ([0,x_car_lower_width/2,x_car_bottom_height]) rotate([0,90,0])
			cylinder(h=x_car_length+1,r=5,center=true);
		// Holes at distal X ends.
		x_carriage_common_holes()
		// Trimming of top edge
		translate ([0,x_car_lower_width/2+1,x_car_bottom_height]) rotate ([90,0,0])
			cylinder(h=x_car_length+2,r=3,center=true);
		...
		// Angled axes
		translate ([x_car_bottom_axle_offset,x_car_lower_width/-2-1.5,-1.5]) rotate ([-30,0,0]) m4_hole_vert(40);
		translate ([-x_car_bottom_axle_offset,x_car_lower_width/-2-1.5,-1.5]) rotate ([-30,0,0]) m4_hole_vert(40);
		translate ([x_car_length/-2+8,(x_car_lower_width+x_car_shelf_width*0.6)/-2,-1.5]) rotate ([30,0,0])
			m4_hole_vert(40);
		translate ([x_car_length/2-8,(x_car_lower_width+x_car_shelf_width*0.6)/-2,-1.5]) rotate ([30,0,0])
			m4_hole_vert(40);
	}
